page 50022 "FSR Order Subform"
{
            ...
            repeater(Control1)
            {
                ...
                field("Item Reference No."; rec."Item Reference No.")
                {
                    ...
                    begin
                        ...
                        DeltaUpdateTotals();
#if not CLEAN20
                        //OnCrossReferenceNoOnLookup(Rec); //PCPL/NSW/07 13Oct22
                ...
                field(Description; Rec.Description)
                {
                    ...
                    begin
                        ...
                        // Rec.RestoreLookupSelection();//PCPL
                    ...
                    begin
                        //rec.SaveLookupSelection(Selected);//PCPL
                    end;
                }
    ...
    begin
        if (rec.Type = Type::Item) and rec.IsAsmToOrderRequired then begin
            CurrPage.SaveRecord();
            rec.AutoAsmToOrder();
            CurrPage.Update(false);
        end;
    ...
    begin
        LocationCodeMandatory := InventorySetup."Location Mandatory" and (rec.Type = Type::Item);
    end;
